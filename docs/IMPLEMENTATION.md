...
This app is an Android client app developed in Android studio and maintained in the /mobile directory, and a Django DRF backend app that is maintained in the /backend directory. The app should use both wsgi with gunicorn and asgi with daphne.
...
-The app should also be able to send pictures, videos, and voice messages.